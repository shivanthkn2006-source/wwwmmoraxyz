...
Command: npx gltfjsx@6.5.3 /dev-server/src/assets/models/zero-two-upload-2.glb --printwidth 120 
...
export function Model(props) {
  const { nodes, materials } = useGLTF('/zero-two-upload-2.glb')
  return (
...
useGLTF.preload('/zero-two-upload-2.glb')
