...
Command: npx gltfjsx@6.5.3 /dev-server/src/assets/models/zero-two-motorcycle.glb --printwidth 120 
...
export function Model(props) {
  const { nodes, materials } = useGLTF('/zero-two-motorcycle.glb')
  return (
...
useGLTF.preload('/zero-two-motorcycle.glb')
