...
export const ZOE_INFINITY_FEATURES: ZoeFeature[] = [
  ...
  },
  {
    ...
    voiceCommand: ['voice', 'speak'],
    description: 'Browser-based voice synthesis that works everywhere',
    detailedDescription: 'Uses built-in browser speech synthesis for zero-cost voice output. Works offline and across all devices. Voice quality adapts to your device capabilities.',
    howToUse: 'Voice is always available. Zoe speaks responses automatically.',
    category: 'voice',
    status: 'active',
    creditCost: 'free',
    worksOffline: true,
  ...
  },
  {
    ...
    voiceCommand: [],
    description: 'Reliable voice system that works across all platforms',
    detailedDescription: 'Browser-native voice synthesis that adapts to your device. Works offline, zero cost, and always available.',
    howToUse: 'Automatic - voice is always active.',
    category: 'voice',
    status: 'active',
    creditCost: 'free',
    worksOffline: true,
